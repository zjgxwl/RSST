...
# ViT-Small Head+MLP组合剪枝实验
# 模型: vit_small (预训练)
# 剪枝: Head + MLP Neurons (准结构化)
# 数据集: CIFAR-10, CIFAR-100
# 方法: Refill, RSST
# Criteria: magnitude (权重幅度)
...
echo "  tail -f logs_vit_small/cifar10_rsst_${TIMESTAMP}.log"
echo "  tail -f logs_vit_small/cifar100_refill_${TIMESTAMP}.log"
echo "  tail -f logs_vit_small/cifar100_rsst_${TIMESTAMP}.log"
echo ""
echo "查看运行状态:"
